  ...
  try {
    ...
    const response = {
      ...
      modifications: booking.modifications.map(mod => ({
        ...
        processedAt: mod.processedAt?.toISOString(),
        originalCheckIn: mod.originalCheckIn?.toISOString(),
        originalCheckOut: mod.originalCheckOut?.toISOString(),
